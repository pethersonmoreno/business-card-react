...
export default function IconLinkedin() {
  return (
    <svg aria-label="Linkedin" height="50" width="50" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      <g>
        <path clipRule="evenodd" d="M256.23,512C396.81,512,512,396.81,512,256.23   C512,115.184,396.81,0,256.23,0C115.184,0,0,115.184,0,256.23C0,396.81,115.184,512,256.23,512L256.23,512z" fill="white" fillRule="evenodd" />
        <path
          clipRule="evenodd"
